...
export const ToggleThemeButton = () => {
    ...
    return <>
        <button
            ...
            onClick={changeTheme}>
            <div
                class={`w-6 h-6 md:w-7 md:h-7 relative rounded-full transition duration-500 transform dark:bg-yellow-500 bg-bunker-300  p-1 text-white ${isDark ? 'translate-x-5' : '-translate-x-2'} `}>
